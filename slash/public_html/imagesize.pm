...
# the following 150 or so lines of code is ripped off from 
...
# Much Thanks to them.
# All it does is get the size (h&w) from either a gif or jpg.  This
# whole thing should be replaced by a CPAN module which does the same
# thing, but this works until I have a chance to replace it.
